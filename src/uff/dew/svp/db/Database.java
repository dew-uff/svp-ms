...
public interface Database {
     ...
     * Create a empty collection in the database
     * 
     * @param collectionName The name of the collection to be verified
     * @throws XQException
     * @author lzomatos
     */
    ...
    //Luiz Matos
    /**
     * Add a XML string in the given collection of the database
     *     
     * @param collectionName The name of the collection to be updated
     * @param contentXML The XML string to be added
     * @throws XQException
     */
