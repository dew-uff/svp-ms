...
public class PartitionTunerMT_NonUniform extends PartitionTuner {
 ...
 // PartitionTuner States
    ...
    private final float MEANTIME_GROWTH_TOLERANCE = (float) 0.5; // to be applied over the "size increasing tax" being used
    private final float MEANTIME_SET_TOLERANCE = (float) 0.5; // to be used while evaluating current size
     ...
     */
    private final float MEANTIME_LOW_DENSITY_TOLERANCE = (float) 1; // to be used while evaluating current size in low-density regions
